...
[![Build Status](https://travis-ci.org/vildanbina/entrust.svg)](https://travis-ci.org/vildanbina/entrust)
[![Version](https://img.shields.io/packagist/v/vildanbina/entrust.svg)](https://packagist.org/packages/vildanbina/entrust)
[![License](https://poser.pugx.org/vildanbina/entrust/license.svg)](https://packagist.org/packages/vildanbina/entrust)
[![Total Downloads](https://img.shields.io/packagist/dt/vildanbina/entrust.svg)](https://packagist.org/packages/vildanbina/entrust)
...
If you are looking for the Laravel 4 version, take a look [Branch 1.0](https://github.com/vildanbina/entrust/tree/1.0). It
...
use vildanbina\Entrust\EntrustRole;
...
use vildanbina\Entrust\EntrustPermission;
...
use vildanbina\Entrust\Traits\EntrustUserTrait;
...
If you don't, then try `php artisan vendor:publish` and, if it does not appear, manually copy the `/vendor/vildanbina/entrust/src/config/config.php` file in your config directory and rename it `entrust.php`.
