...
use vildanbina\Entrust\Contracts\EntrustUserInterface;
use vildanbina\Entrust\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use vildanbina\Entrust\Permission;
use vildanbina\Entrust\Role;
use Mockery as m;
...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $permMock = m::mock('vildanbina\Entrust\Permission');
    ...
    {
        $roleMock = m::mock('vildanbina\Entrust\Role');
